...
void VueOpenGL::dessine(Masse const& a_dessiner){
  QMatrix4x4 matrice;
  Vecteur3D pos(a_dessiner.getPos());
...
void VueOpenGL::dessine(Contrainte const& a_dessiner){
  Vecteur3D couleur;
  bool dessinable;
  a_dessiner.dessinable(dessinable,couleur);
  if(dessinable){
    QMatrix4x4 matrice;
    Vecteur3D centre(a_dessiner.getCentre());
    matrice.translate(centre.x(),centre.y(),centre.z());
    matrice.scale(a_dessiner.getRayon());
    glPolygonMode(GL_FRONT_AND_BACK, GL_LINE);
    dessineSphere(matrice, couleur.x(), couleur.y(), couleur.z());
  }
}
...
void VueOpenGL::initializePosition()
{
  ...
  matrice_vue.rotate(180,0,1,0);
  matrice_vue.rotate(180,0,0,1);
  matrice_vue.translate(0,10,0);
}
...
void VueOpenGL::dessineLigne (Vecteur3D const& pos1, Vecteur3D const& pos2, QMatrix4x4 const& point_de_vue)
{
  prog.setUniformValue("vue_modele", matrice_vue*point_de_vue);
